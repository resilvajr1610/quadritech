          ...
          child: Column(
            children: [
              ...
              _sending == false && widget.type != 'Foto do Aluno'
                  ?TextCustom(text: 'KM Final',size: 18.0)
                  :Container(),
                    ...
                    onPressed: () {
                      if(_urlPhoto==""){
                        ...
                        if (widget.type == 'Foto do Aluno') {
                          ...
                          if(_controllerKM.text.isEmpty){
                            showSnackbar(context, 'Insira o KM final para avançar', _scaffoldKey);
                          }else{
                            db.collection("lesson").doc(widget.idLesson).update({
                              'kmFinal' : _controllerKM.text,
